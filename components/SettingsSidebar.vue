...
<template>
  <nav
    class="fixed top-0 left-0 bottom-0 z-10 min-w-[200px] overflow-auto border-r border-slate-150 bg-white px-4 py-4 text-slate-700 shadow-md dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 md:static md:shadow-none"
