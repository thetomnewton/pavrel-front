...
<template>
  <nav
    ref="nav"
    class="fixed top-0 left-0 z-20 flex h-full w-[300px] min-w-[200px] max-w-[80%] flex-col border-r border-slate-100 bg-slate-50 text-slate-700 shadow transition dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-300 lg:relative lg:w-[200px] lg:shadow-none lg:transition-none"
  ...
  >
              ...
              <Dropdown width="230px" align="left" trigger-wrapper-classes="w-full">
                <template #trigger="{ open }">
                  ...
                  >
                    <button class="flex flex-shrink-0 cursor-default items-center rounded py-[6px] pl-[10px] pr-2">
                      <WorkspaceIcon class="mr-[10px] bg-blue-500" :initial="currentWorkspace.initial" />
                ...
                <template #content>
                  <div class="px-2 py-1 text-[.8125rem]">
                    ...
                    >
                      <WorkspaceIcon class="mr-[10px] bg-blue-500" :initial="workspace.initial" />
    ...
    <div class="mx-4 mb-3 mt-1">
      <button
        ...
        class="group inline-flex w-full cursor-default items-center rounded-md border border-slate-400 bg-slate-50 py-1.5 pl-[7px] text-[13px] font-medium leading-5 shadow-sm transition hover:shadow active:translate-y-px active:bg-slate-100 active:shadow-none disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-500 dark:bg-zinc-800 dark:hover:border-zinc-400 dark:hover:text-zinc-200 dark:active:bg-[#252528]"
      >
        <PlusIcon
          class="mr-[7px] h-[18px] w-[18px] text-slate-500 transition dark:text-zinc-400 dark:group-hover:text-zinc-200"
        />
        <span>New idea</span>
      </button>
    </div>
