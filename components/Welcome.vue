...
<template>
  <div>
    ...
    <div class="grid grid-cols-1 bg-slate-200 bg-opacity-25 md:grid-cols-2">
      <div class="p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4 text-lg font-semibold leading-7 text-slate-600">
      ...
      <div class="border-t border-slate-200 p-6 md:border-t-0 md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
      ...
      <div class="border-t border-slate-200 p-6 md:border-l">
        <div class="flex items-center">
          <svg
            fill="none"
            stroke="currentColor"
