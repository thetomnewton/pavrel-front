...
const errors = ref<{ password: [] } | null>(null)
    ...
    <template #content>
      ...
      <div class="mt-5 space-y-6" v-if="sessions.length > 0">
        <div class="flex items-center" v-for="(session, i) in sessions" :key="i">
          ...
          <div class="ml-3">
            <div class="text-sm text-slate-600">{{ session.agent.platform }} - {{ session.agent.browser }}</div>
      ...
      <div class="mt-5 flex items-center">
        ...
        <JetActionMessage :on="recentlySuccessful" class="ml-3"> Done. </JetActionMessage>
      </div>
      ...
      <JetDialogModal :show="confirmingLogout" @close="closeModal">
        ...
        <template #content>
          ...
          <div class="mt-4">
            ...
            <JetInputError :message="errors && errors.password" class="mt-2" />
          </div>
        </template>
